function [ res ] = flmm_lu( Y, X, Z, FDR, SIMspecs, TSspecs, MCMCspecs, wavespecsx, wavespecsy, gbf, saveraw, pcaspecsx)
%function [ res ] = flmm(  )
%==========================================================================
...
%     fprintf('\n Done scaling Y.\n \n');
    ...
    res         = wavfmm4_lu(Y,model,wavespecsy,wavespecsc,pcaspecsx,MCMCspecs,sampleU,get_sigma,twosample,saveraw);
