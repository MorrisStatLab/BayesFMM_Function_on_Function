function [ res ] = flmm( Y, X, Z, FDR, TSspecs, MCMCspecs, wavespecsx, wavespecsy, gbf, saveraw, pcaspecsx)
%function [ res ] = flmm(  )
%==========================================================================
...
%   Detailed explanation goes here
    ...
    if twosample == 1;
        group           = TSspecs.group;
        model.delt0     = TSspecs.delt0;
        model.delt1     = TSspecs.delt1;
    end;
    ...
    res         = wavfmm4_gbf(scaleY,model,wavespecsy,wavespecsc,pcaspecsx,MCMCspecs,sampleU,get_sigma,twosample,saveraw);
