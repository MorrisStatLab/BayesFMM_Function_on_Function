function [ res ] = flmm_chains( Y, X, Z, FDR, TSspecs, MCMCspecs, wavespecsx, wavespecsy, gbf, saveraw, pcaspecsx)
%function [ res ] = flmm(  )
%==========================================================================
...
%   Detailed explanation goes here
    ...
    res         = wavfmm4_chains(scaleY,model,wavespecsy,wavespecsc,pcaspecsx,MCMCspecs,sampleU,get_sigma,twosample,saveraw);
